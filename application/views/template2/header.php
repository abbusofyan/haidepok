      ...
      <ul class="nav navbar-nav flex-row">
        ...
        <li class="nav-item">
          <a class="navbar-brand" href="index.html">
            <img class="brand-logo" alt="modern admin logo" src="<?php echo base_url('assets/img/banner/logo.png');?>">
            <h3 class="brand-text">Hai Depok</h3>
          </a>
        </li>
          ...
          <li class="dropdown dropdown-user nav-item">
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              ...
              <span class="avatar avatar-online">
                <img src="<?php echo base_url('assets2/images/users/user-1.jpg');?>" alt="avatar"><i></i></span>
            </a>
